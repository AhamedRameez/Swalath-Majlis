...
class _DuasScreenState extends State<DuasScreen> {
  ...
  Future<void> _loadData() async {
    try {
      ...
      // Load ALL duas (both categorized and uncategorized)
      ...
      print('Found ${allDuasSnapshot.docs.length} total duas');

      // Get unique categories from duas (to show only categories that have duas)
      ...
      print('Total duas to display: ${allDuas.length}');
    } catch (e) {
        ...
        title: _isSearching
            ? TextField(
                ...
                decoration: InputDecoration(
                  hintText: 'Search duas or categories...',
                  hintStyle: TextStyle(
