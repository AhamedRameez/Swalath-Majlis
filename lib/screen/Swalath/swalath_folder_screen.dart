// lib/screen/user/swalath_folder_screen.dart
import 'package:flutter/material.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'swalath_details_screen.dart';

class SwalathFolderScreen extends StatelessWidget {
  final String folderName;

  const SwalathFolderScreen({super.key, required this.folderName});
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'Unable to load swalath. Please try again.',
      ...
      child: InkWell(
        onTap: () {
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (_) =>
                  SwalathDetailScreen(swalathData: data, docId: docId),
            ),
          );
        },
        borderRadius: BorderRadius.circular(16),
