// lib/screens/ramzan_dua_detail_screen.dart
import 'package:flutter/material.dart';
import 'package:share_plus/share_plus.dart'; // Add this dependency
import 'ramzan_dua_category_screen.dart';

class RamzanDuaDetailScreen extends StatelessWidget {
  final Map<String, dynamic> data;

  const RamzanDuaDetailScreen({super.key, required this.data});
  ...
  Widget build(BuildContext context) {
    ...
    final hasAnyContent =
        arabic.isNotEmpty || english.isNotEmpty || malayalam.isNotEmpty;
                      ...
                      GestureDetector(
                        onTap: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (_) =>
                                  RamzanCategoryDuasScreen(category: category),
                            ),
                          );
                        },
                        child: Container(
