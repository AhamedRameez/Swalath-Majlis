// lib/screens/ramzan_dua_enter_screen.dart
import 'package:flutter/material.dart';
import 'package:cloud_firestore/cloud_firestore.dart';

class RamzanDuasEnterScreen extends StatefulWidget {
  final bool isEditMode;
  final Map<String, dynamic>? duaData;
  final String? docId;

  const RamzanDuasEnterScreen({
    super.key,
  ...
  @override
  State<RamzanDuasEnterScreen> createState() => _RamzanDuasEnterScreenState();
}

class _RamzanDuasEnterScreenState extends State<RamzanDuasEnterScreen> {
  ...
  Future<void> _loadExistingCategories() async {
    try {
      final snapshot = await FirebaseFirestore.instance
          ...
          .collection(
              'ramzancategories') // 🔴 CHANGED: from 'categories' to 'ramzancategories'
          .orderBy('name')
          .get();
  ...
  Future<void> _saveDua() async {
    ...
    try {
      // Create a reference to the Ramzan duas collection
      final duasRef = FirebaseFirestore.instance
          .collection('swalathmajlis')
          .doc('iM6QRMlgUuWNbUdgQ0')
          .collection(
              'Ramzan_duas'); // 🔴 CHANGED: from 'duas' to 'Ramzan_duas'
      ...
      if (widget.isEditMode && widget.docId != null) {
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: const Text('Ramadan Dua updated successfully'),
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: const Text('Ramadan Dua added successfully'),
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          widget.isEditMode
              ? 'Edit Ramadan Dua'
              : 'Enter Ramadan Dua', // 🔴 Updated title
                    ...
                    Container(
                      ...
                      child: Icon(
                        widget.isEditMode
                            ? Icons.edit_rounded
                            : Icons
                                .ramen_dining_rounded, // 🔴 Changed icon for Ramadan
                        color: primaryColor,
                        size: 24,
                      ),
                    ),
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            widget.isEditMode
                                ? 'Edit Ramadan Dua'
                                : 'Add New Ramadan Dua', // 🔴 Updated text
                            style: TextStyle(
                              color: textPrimary,
                              fontSize: 16,
                          ...
                          Text(
                            widget.isEditMode
                                ...
                                : 'Add Ramadan special duas with categories',
                            style: TextStyle(
                              color: textSecondary,
                              fontSize: 13,
                              fontFamily: 'Poppins',
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    const SizedBox(width: 12),
                    Text(
                      'Add to Ramadan Category', // 🔴 Updated text
                      style: TextStyle(
                        color: textPrimary,
                        fontSize: 14,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            'Select or Create Ramadan Category', // 🔴 Updated text
                            style: TextStyle(
                              color: textPrimary,
                              fontSize: 14,
                              fontWeight: FontWeight.w600,
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    Text(
                                      'Existing Ramadan Categories', // 🔴 Updated text
                                      style: TextStyle(
                                        color: textPrimary,
                                        fontSize: 13,
                                        fontWeight: FontWeight.w500,
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  const SizedBox(width: 8),
                                  Text(
                                    'Create New Ramadan Category', // 🔴 Updated text
                                    style: TextStyle(
                                      color: textPrimary,
                                      fontSize: 13,
                                      fontWeight: FontWeight.w500,
                                  ...
                                  Expanded(
                                    child: TextField(
                                      ...
                                      decoration: InputDecoration(
                                        hintText:
                                            'Enter new Ramadan category name...', // 🔴 Updated hint
                                        hintStyle: TextStyle(
                              ...
                              if (_categoryController.text.trim().isNotEmpty)
                                Padding(
                                  ...
                                  child: Text(
                                    'New Ramadan category: ${_categoryController.text.trim()}', // 🔴 Updated text
                                    style: TextStyle(
                                      color: primaryColor,
                                      fontSize: 11,
                                      fontFamily: 'Poppins',
                            ...
                            child: Container(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Expanded(
                                    child: Text(
                                      'Selected Ramadan category: ${_isNewCategory ? _categoryController.text.trim() : _selectedCategory}', // 🔴 Updated text
                                      style: TextStyle(
                                        color: primaryColor,
                                        fontSize: 13,
                                        fontWeight: FontWeight.w500,
