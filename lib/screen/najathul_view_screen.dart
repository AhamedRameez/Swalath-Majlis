...
class NajathulViewScreen extends StatefulWidget {
  final String title;
  final String pdfPath;

  // Updated constructor with default value
  const NajathulViewScreen({
    super.key,
    required this.title,
    this.pdfPath = 'assets/pdfs/Majlis.pdf', // Default value
  });

  @override
  State<NajathulViewScreen> createState() => _NajathulViewScreenState();
}

class _NajathulViewScreenState extends State<NajathulViewScreen> {
  ...
  Future<void> _loadPdfFromAssets() async {
    ...
    try {
      ...
      const fileName = 'Majlis.pdf';
      final file = File('${directory.path}/$fileName');

      // Check if PDF already exists in local storage
      if (await file.exists()) {
        print('✅ Majlis PDF found in local storage: ${file.path}');
        setState(() {
      ...
      print('📚 Copying Majlis PDF from assets to local storage...');
      ...
      print('✅ Majlis PDF saved to local storage: ${file.path}');
