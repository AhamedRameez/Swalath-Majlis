// lib/screen/user/moulood_folder_screen.dart
import 'package:flutter/material.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'moulood_detail_screen.dart';

class MouloodFolderScreen extends StatelessWidget {
  final String folderName;
  final List<Map<String, dynamic>> staticMouloods; // 🔥 ADD THIS

  const MouloodFolderScreen({
    super.key,
    required this.folderName,
    this.staticMouloods = const [], // 🔥 ADD THIS with default value
  });
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'Unable to load moulood. Please try again.',
      ...
      child: InkWell(
        onTap: () {
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (_) =>
                  MouloodDetailScreen(mouloodData: data, docId: docId),
            ),
          );
        },
        borderRadius: BorderRadius.circular(16),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      // Only show Dua badge if present
                      if (hasDua) ...[
                        const SizedBox(height: 8),
                        Container(
